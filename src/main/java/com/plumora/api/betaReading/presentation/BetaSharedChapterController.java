...
public class BetaSharedChapterController {
	...
	@PostMapping("/beta-campaigns/{campaignId}/chapters/{chapterId}/views")
	@ResponseStatus(HttpStatus.NO_CONTENT)
	@PreAuthorize("hasRole('BETA_READER')")
	public void recordChapterView(Principal principal, @PathVariable UUID campaignId, @PathVariable UUID chapterId) {
		betaReadingService.recordChapterView(principal.getName(), campaignId, chapterId);
	}
}
